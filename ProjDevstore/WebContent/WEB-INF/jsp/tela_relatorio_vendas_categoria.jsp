...
<%
	...
	vendas = pDAO.pesquisarTotalVendasPCategoria(v.getIdVendedor());

%>

<body style="z-index: -1">
	
	<strong><h4 class="card-title mt-5 text-dark">Total de itens vendidos por categoria</h4></strong>
	<div class="row-12 justify-content-center mb-5">
		<table class="table table-striped bg-white border">
			  <thead>
			    <tr>
			      <th scope="col" class="text-center">Categoria</th>
			      <th scope="col" class="text-center">Quantidade de itens</th>
			      <th scope="col" class="text-center">Total retornado</th>
			    </tr>
			  </thead>
			  <tbody>
			  	<%
			  	for(TotVendasCat tvs : vendas){%>
				    <tr>
				      <td class="text-center"><%= tvs.getCategoria() %></td>
