	...
	<div class="container">
		<div class="col-md-6" style="margin:0 auto;">
			...
			<div class="card-body rounded bg-white py-5" style="margin:0 auto;">
				<form id="formLogin" action="./check?tpl=${tpl}" method="post">
					<div class="row">
						<div class="col">
					...
					<div class="row mb-3">
						<div class="col">
							<input type="submit" value="Logar como <%= 
									(session.getAttribute("tpl").toString().equals("0")) ? "Cliente" : "Vendedor"
				...
				<div class="row">
					<div class="col">
						<input type="button" onclick="location.href='./log?tp=0'" value="Voltar" class="btn btn-danger btn-lg w-100 mb-3"/>
					</div>
				</div>
			</div>
		</div>
