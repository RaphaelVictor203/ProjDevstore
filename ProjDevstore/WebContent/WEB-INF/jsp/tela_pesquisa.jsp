...
<%
	...
	produtoList = (ArrayList<Produto>) session.getAttribute("produtos");
	/*produtoList = pDAO.pesquisaEspecifica(Integer.parseInt(request.getParameter("tip")), 
										  Integer.parseInt(request.getParameter("fx")), 
										  request.getParameter("nmP"));*/
...
<body style="background-color: #F5F5F5">
	...
	<div class="container">
		...
		<div class="row-12">
			<strong><h4 class="card-title mt-5 text-dark">Produtos relacionados</h4></strong>
		</div>
	
		<div class="row-12 mb-3">
			<form id="formPesquisaProduto" action="/ProjDevstore/produto/pesquisa" method="post">
				<div class="row">
					<div class="col">
